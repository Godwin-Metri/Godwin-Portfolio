      ...
      <FadeIn>
        <div className="flex flex-col items-center gap-6 text-center max-w-2xl mx-auto">
          ...
          <div className="flex gap-4 pt-4">
            <a
              href="#projects"
              className="inline-flex items-center justify-center px-6 py-3 rounded-md bg-gray-900 text-white text-sm font-medium hover:bg-gray-800 hover:-translate-y-0.5 active:scale-95 transition-all duration-200"
            >
              View Projects
            </a>
